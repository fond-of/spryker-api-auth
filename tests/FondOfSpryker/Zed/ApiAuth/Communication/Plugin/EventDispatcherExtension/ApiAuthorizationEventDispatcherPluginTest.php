...
class ApiAuthorizationEventDispatcherPluginTest extends Unit
{
    ...
    /**
     * @var \FondOfSpryker\Zed\ApiAuth\Business\ApiAuthFacade|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $apiAuthFacadeMock;

    /**
     * @var \PHPUnit\Framework\MockObject\MockObject|\Symfony\Component\HttpKernel\Event\GetResponseEvent
     */
    ...
    /**
     * @var \FondOfSpryker\Zed\ApiAuth\Communication\Plugin\EventDispatcherExtension\ApiAuthorizationEventDispatcherPlugin
     */
    ...
    public function testOnKernelRequest(): void
    {
        ...
        $this->getResponseEventMock->expects(self::atLeastOnce())
            ->method('getRequest')
        ...
        $this->getResponseEventMock->expects(self::never())
            ->method('setResponse')
